...
for(let i=1; i<=10; i++){                                 // for loop that iterate 10 times
    myArray.push(i)                                       //add values into the array
}
console.log(myArray);                                     //print array values
console.log("\n Array with index and values:")
for(let j=0 ; j <myArray.length ; j++){                   //for loop 
    console.log(`Index ${j}: Element ${myArray[j]}`);      //print array index and array values
}

console.log("\n Array Elements using For OF Loop")
for(let x of myArray){                                     // for of loop that 
