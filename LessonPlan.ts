...
let myWork : {name:string ,status: boolean}[]=[];                            //blank array that hold object properties

for(let i=1; i<=10; i++){                                                   //for loop that runs from 1 to 10
    let lesson = {                                                         //object lesson 
        name: `Lesson ${i}`,                                              
        status: i%2 === 1                                                  //if i%2 =1 it sets true otherwise it sets false in status property
    };
    myWork.push(lesson);                                                   //add lesson to myWork array
}

console.log(myWork);                                                       //print myWork array
